...
local page = 1
local putLimit = ""
-- local version = "1.0" (original fixed version)
local version = "1.2.5"
local timediff = 0
local monthDays = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30 ,31}

print("")
print("Made by Game4Freak")
print("Edited by MarkusTieger")
print("Version: "..version)

local alarm = false

local function alarmColor()
    if alarm == true then
...
local function alarmCore()
    if alarm == true then
        colorCore = colors.red
    else
...
local function drawBox(xMin, xMax, yMin, yMax, title)
	...
	-- mon.setBackgroundColor(colors.black) old_tiger
